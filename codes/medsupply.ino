...
// TODO: Set a secure password for the Access Point
const char* password = "REPLACE_WITH_AP_PASSWORD";

// --- ESP-NOW & WiFi STA CONFIG ---
const char* GLOVE_AP_SSID = "Health Monitor"; // The SSID of the smart glove's AP
